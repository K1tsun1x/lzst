...
void sw_int_init(void) {
	idt32_set_entry(IDT_SW_INT_SCHEDULER_YIELD_VECTOR, (uint32_t)sw_int_stub0, 0x08, IDT_TYPE_INT32, IDT_FLAG_PRESENT);
	idt32_set_entry(IDT_SW_INT_TTY_VECTOR, (uint32_t)sw_int_stub1, 0x08, IDT_TYPE_INT32, IDT_FLAG_PRESENT);
