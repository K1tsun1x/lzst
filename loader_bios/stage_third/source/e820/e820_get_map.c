...
static inline boot_mem_reg_type_t __e820_ard_type_to_boot_mem_reg_type(uint32_t type) {
	switch(type) {
		case E820_ARD_TYPE_MEM:			return BOOT_MEM_REG_TYPE_NORMAL;
		case E820_ARD_TYPE_RESERVED:	return BOOT_MEM_REG_TYPE_RESERVED;
		case E820_ARD_TYPE_ACPI:		return BOOT_MEM_REG_TYPE_ACPI;
		case E820_ARD_TYPE_NVS:			return BOOT_MEM_REG_TYPE_NVS;
		case E820_ARD_TYPE_UNUSABLE:	return BOOT_MEM_REG_TYPE_UNUSABLE;
		case E820_ARD_TYPE_DISABLED:	return BOOT_MEM_REG_TYPE_DISABLED;
		case E820_ARD_TYPE_PERSISTENT:	return BOOT_MEM_REG_TYPE_PERSISTENT;
		case E820_ARD_TYPE_UNACCEPTED:	return BOOT_MEM_REG_TYPE_UNACCEPTED;
		default:						return BOOT_MEM_REG_TYPE_UNKNOWN;
	}
}
...
bool e820_get_map(boot_mem_reg_t* buffer, size_t max_len, size_t* out_len) {
	...
	while (clength < max_len) {
		...
		buffer[clength].type = __e820_ard_type_to_boot_mem_reg_type(__TMP_ARD.type);
		clength += 1;
